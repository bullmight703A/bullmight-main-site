        ...
        const IROConsole = () => {
          ...
          React.useEffect(() => {
              ...
              const fetchLessonStatus = async () => {
                  try {
                      // Fetch from unified tunnel port 3006
                      const res = await fetch('http://74.92.194.249:3006/api/lesson-plan-status').catch(e => null);
                      if (res && res.ok) {
                         const data = await res.json();
              ...
              const fetchAgStatus = async () => {
                  try {
                      const res = await fetch('http://74.92.194.249:3006/api/ag-status').catch(e => null);
                      if (res && res.ok) {
                         const data = await res.json();
          ...
          const handleSendChat = async (overrideText = null) => {
            ...
            try {
                const res = await fetch('http://74.92.194.249:3006/api/chat', {
                    method: 'POST',
          ...
          const handleApproveAg = async (cmdId) => {
             try {
                await fetch('http://74.92.194.249:3006/api/ag-approve', {
                   method: 'POST',
                   headers: {'Content-Type': 'application/json'},
