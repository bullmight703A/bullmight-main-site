...
<head>
    ...
    <style>
        ...
        .glow-gold {
            box-shadow: 0 0 40px -10px rgba(217, 119, 6, 0.2);
        }
        .blur-orb-1 {
        ...
        const App = () => {
            ...
            return (
                <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 flex flex-col min-h-screen">
                    ...
                    <header className="flex flex-col md:flex-row items-center justify-between border-b border-slate-800 pb-6 mb-10 gap-4">
                        <div className="text-center md:text-left">
                            <h1 className="font-display text-2xl md:text-3xl font-bold tracking-widest text-white leading-tight uppercase cursor-pointer" onClick={() => setActiveTab('home')}>
                                Dr. Diana B. Allen
                            </h1>
                        ...
                        <nav className="flex flex-wrap justify-center gap-1 md:gap-3 bg-brand-slateLight/30 p-1.5 rounded-xl border border-white/5 backdrop-blur-md">
                            ...
                            <section className="animate-fade-in grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                                ...
                                <div className="lg:col-span-7 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                        <div className="flex items-start gap-3 p-3 bg-brand-slateLight/20 border border-white/5 rounded-xl">
                                            <div className="p-2 bg-brand-teal/10 rounded-lg text-brand-teal mt-0.5">
                                                <Icon name="Shield" size={18} />
                                            </div>
                                            <div>
                                                <h4 className="text-sm font-bold text-white uppercase tracking-wider">IT Security & Governance</h4>
                                                <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">Securing core infrastructures and setting governance benchmarks.</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3 p-3 bg-brand-slateLight/20 border border-white/5 rounded-xl">
                                            ...
                                            <div>
                                                <h4 className="text-sm font-bold text-white uppercase tracking-wider">Compliance Alignment</h4>
                                                <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">Systematic roadmap design for SOC2, ISO27001, and regulatory standards.</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3 p-3 bg-brand-slateLight/20 border border-white/5 rounded-xl">
                                            <div className="p-2 bg-brand-teal/10 rounded-lg text-brand-teal mt-0.5">
                                            ...
                                            <div>
                                                <h4 className="text-sm font-bold text-white uppercase tracking-wider">Executive Administration</h4>
                                                <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">Strategic growth optimization, operations audit, and data alignment.</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3 p-3 bg-brand-slateLight/20 border border-white/5 rounded-xl">
                                            <div className="p-2 bg-brand-gold/10 rounded-lg text-brand-gold mt-0.5">
                                            ...
                                            <div>
                                                <h4 className="text-sm font-bold text-white uppercase tracking-wider">Women in Tech Leadership</h4>
                                                <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">Dedicated leadership coaching and high-performance framework building.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                        ...
                                        <button 
                                            ...
                                            className="px-6 py-3 bg-brand-slateLight/50 border border-white/10 hover:border-brand-teal text-white font-bold rounded-lg uppercase tracking-wider transition-colors text-sm flex items-center justify-center gap-2"
                                        >
                                ...
                                <div className="lg:col-span-5 flex flex-col items-center">
                                    <div className="relative group">
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-tr from-brand-teal to-brand-gold rounded-3xl blur-2xl opacity-35 group-hover:opacity-50 transition-opacity duration-300"></div>
                                        {/* Headshot Card Container */}
                                        <div className="relative bg-brand-slateLight border border-white/10 p-4 rounded-3xl shadow-2xl flex flex-col items-center max-w-[340px] text-center">
                                            <img 
                                                src={headshotUrl} 
                                                alt="Dr. Diana B. Allen Executive Portrait" 
                                                className="w-full h-80 object-cover rounded-2xl border border-white/5 mb-4 shadow-inner"
                                            />
                                            <h3 className="font-display text-lg font-bold text-white">Dr. Diana B. Allen</h3>
                                            <p className="text-xs text-brand-teal font-semibold tracking-wider uppercase mt-1">PhD &bull; MBA &bull; CISSP</p>
                                            <div className="w-12 h-[1px] bg-slate-700 my-3"></div>
                        ...
                        {activeTab === 'about' && (
                            <section className="animate-fade-in space-y-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                                    <div className="p-6 bg-brand-slateLight/40 border border-white/5 rounded-2xl space-y-3">
                                        <h3 className="font-display text-xl font-bold text-white uppercase tracking-wider">Decades of Multi-Dimensional Expertise</h3>
                                    ...
                                    <div className="p-6 bg-brand-slateLight/40 border border-white/5 rounded-2xl space-y-3">
                                        <h3 className="font-display text-xl font-bold text-white uppercase tracking-wider">Evidence-Based Leadership</h3>
                                        <p className="text-sm text-slate-400 leading-relaxed font-light">
                                ...
                                <div className="p-8 bg-gradient-to-r from-brand-teal/10 to-brand-gold/10 border border-white/10 rounded-2xl relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                                        ...
                                        <div className="space-y-2">
                                            <h4 className="font-display text-lg font-bold text-white uppercase tracking-wide">Executive Leadership Development</h4>
                        ...
                        {activeTab === 'advisory' && (
                            <section className="animate-fade-in space-y-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="bg-brand-slateLight/30 border border-white/5 p-6 rounded-2xl flex flex-col justify-between hover:border-brand-teal/50 hover:bg-brand-slateLight/50 transition-all duration-300">
                                        <div className="space-y-4">
                                            <div className="p-3 bg-brand-teal/10 rounded-xl w-fit text-brand-teal">
                                                <Icon name="Activity" size={24} />
                                            </div>
                                            <h3 className="font-display text-xl font-bold text-white uppercase tracking-wider">Executive Advisory</h3>
                                            <p className="text-sm text-slate-400 leading-relaxed font-light">
                                        ...
                                        <button onClick={() => { setActiveTab('contact'); setFormData(prev => ({ ...prev, interest: 'Advisory Consulting' })); }} className="w-full mt-6 py-2.5 bg-brand-teal/10 hover:bg-brand-teal border border-brand-teal/40 text-brand-tealLight hover:text-white font-bold rounded-lg uppercase tracking-wider transition-colors text-xs">
                                            Select Advisory
                                        </button>
                                    </div>

                                    <div className="bg-brand-slateLight/30 border border-white/5 p-6 rounded-2xl flex flex-col justify-between hover:border-brand-gold/50 hover:bg-brand-slateLight/50 transition-all duration-300">
                                        <div className="space-y-4">
                                            <div className="p-3 bg-brand-gold/10 rounded-xl w-fit text-brand-gold">
                                                <Icon name="MessageSquare" size={24} />
                                            </div>
                                            <h3 className="font-display text-xl font-bold text-white uppercase tracking-wider">Keynotes & Speaking</h3>
                                            <p className="text-sm text-slate-400 leading-relaxed font-light">
                                        ...
                                        <button onClick={() => { setActiveTab('contact'); setFormData(prev => ({ ...prev, interest: 'Speaking & Keynotes' })); }} className="w-full mt-6 py-2.5 bg-brand-gold/10 hover:bg-brand-gold border border-brand-gold/40 text-brand-goldLight hover:text-white font-bold rounded-lg uppercase tracking-wider transition-colors text-xs">
                                            Book Speaking
                                        </button>
                                    </div>
                                    ...
                                    <div className="bg-brand-slateLight/30 border border-white/5 p-6 rounded-2xl flex flex-col justify-between hover:border-brand-teal/50 hover:bg-brand-slateLight/50 transition-all duration-300">
                                        <div className="space-y-4">
                                            ...
                                            <h3 className="font-display text-xl font-bold text-white uppercase tracking-wider">Thought Leadership</h3>
                                            <p className="text-sm text-slate-400 leading-relaxed font-light">
                                        ...
                                        <button onClick={() => { setActiveTab('contact'); setFormData(prev => ({ ...prev, interest: 'Thought Leadership' })); }} className="w-full mt-6 py-2.5 bg-brand-teal/10 hover:bg-brand-teal border border-brand-teal/40 text-brand-tealLight hover:text-white font-bold rounded-lg uppercase tracking-wider transition-colors text-xs">
                                ...
                                <div className="border border-brand-teal/30 bg-brand-slateLight/40 rounded-2xl p-6 md:p-8 glow-teal">
                                    <div className="flex flex-col md:flex-row gap-8">
                                        ...
                                        <div className="flex-1 space-y-6">
                                            <div>
                                                ...
                                                <h3 className="font-display text-2xl font-bold text-white mt-2 uppercase tracking-wide">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label className="text-xs text-slate-300 uppercase tracking-wider font-bold block mb-2">
                                                            ...
                                                            <button 
                                                                ...
                                                                className={`flex-1 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider border transition-colors ${
                                                                    calcAnswers.security === (idx + 1)
                                                                        ...
                                                                        : 'bg-brand-slate/30 border-white/5 text-slate-500 hover:text-slate-300'
                                                                }`}
                                                            >
                                                                {val}
                                                            </button>
                                        ...
                                        <div className="w-full md:w-[300px] flex flex-col justify-center items-center p-6 bg-brand-slate/50 border border-white/5 rounded-xl text-center">
                                            {calcScore === null ? (
                                                <div className="space-y-2 py-10">
                                                    <Icon name="Activity" size={40} className="text-slate-600 animate-pulse mx-auto" />
                                                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Awaiting Diagnostics</p>
                                                </div>
                                            ) : (
                                                <div className="space-y-4 animate-scale-up">
                                                    <p className="text-[10px] text-slate-500 uppercase tracking-[0.2em] font-black">Score Result</p>
                                                    <div className="relative flex items-center justify-center">
                                                        <span className="text-5xl font-black text-white font-display">{calcScore}%</span>
                                                    ...
                                                    <div className="text-xs text-slate-300 leading-relaxed font-light bg-brand-slateLight/40 p-3 rounded-lg border border-white/5">
                                                        {calcScore < 50 ? (
                                                            <span className="text-orange-400 font-bold block mb-1">Status: High Risk Gaps</span>
                                                        ) : calcScore < 80 ? (
                                                            <span className="text-brand-gold font-bold block mb-1">Status: Moderate Alignment</span>
                                                        ) : (
                                                            <span className="text-brand-tealLight font-bold block mb-1">Status: Highly Aligned</span>
                                                        )}
                                                        {calcScore < 80 
                                                    ...
                                                    <button 
                                                        ...
                                                        className="px-4 py-2 bg-brand-gold hover:bg-brand-goldLight text-black font-black text-[10px] rounded uppercase tracking-wider transition-colors inline-block"
                                                    >
                        ...
                        {activeTab === 'insights' && (
                            <section className="animate-fade-in space-y-12">
                                ...
                                {selectedBlog === null ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                                        {[
                                            ...
                                            <div 
                                                ...
                                                className="bg-brand-slateLight/30 border border-white/5 p-6 rounded-2xl hover:border-brand-teal/50 hover:bg-brand-slateLight/50 cursor-pointer group transition-all duration-300"
                                            >
                                                <div className="flex justify-between items-start text-xs text-slate-500 font-bold uppercase tracking-wider mb-2">
                                                    <span>Governance Report</span>
                                                    <span>{post.date}</span>
                                                </div>
                                                <h3 className="font-display text-lg font-bold text-white group-hover:text-brand-tealLight transition-colors uppercase tracking-wide">
                                                    {post.title}
                                                </h3>
                                                <p className="text-xs text-slate-400 mt-2 leading-relaxed font-light line-clamp-3">
                                                    {post.desc}
                                                </p>
                                    ...
                                    /* Single Blog View */
                                    <div className="bg-brand-slateLight/20 border border-white/10 rounded-2xl p-6 md:p-10 space-y-6 animate-scale-up relative">
                                        <button 
                                            onClick={() => setSelectedBlog(null)}
                                            className="px-3 py-1.5 bg-brand-slateLight/50 hover:bg-brand-teal border border-white/10 text-white font-bold rounded-lg uppercase tracking-wider transition-colors text-[10px] flex items-center gap-1.5 w-fit"
                                        >
                                        ...
                                        <div className="border-b border-slate-800 pb-4">
                                            ...
                                            <h3 className="font-display text-2xl md:text-4xl font-black text-white leading-tight uppercase tracking-wide">
                                                {selectedBlog.title}
                                            </h3>
                                        </div>
                                        <div className="text-sm leading-relaxed text-slate-300 space-y-4 font-light">
                                            <p>{selectedBlog.p1}</p>
                                            <p>{selectedBlog.p2}</p>
                                            <p>{selectedBlog.p3}</p>
                                        </div>
                            ...
                            <section className="animate-fade-in grid grid-cols-1 lg:grid-cols-12 gap-12">
                                ...
                                <div className="lg:col-span-5 space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <h2 className="font-display text-3xl md:text-5xl font-black text-white leading-tight uppercase tracking-wide">
                                    ...
                                    <div className="space-y-4 pt-4 border-t border-slate-800">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] text-slate-500 uppercase tracking-widest font-black">Direct Communication</p>
                                                <p className="text-sm text-white font-bold font-mono">info@dianaballen.com</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] text-slate-500 uppercase tracking-widest font-black">Consulting Range</p>
                                                <p className="text-sm text-white font-semibold">Global Virtual & On-Site</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Form Column */}
                                <div className="lg:col-span-7 bg-brand-slateLight/30 border border-white/5 p-6 md:p-8 rounded-2xl shadow-xl relative overflow-hidden">
                                    {formSubmitted ? (
                                        <div className="flex flex-col items-center justify-center text-center py-16 space-y-4 animate-scale-up">
                                            ...
                                            <h3 className="font-display text-xl font-bold text-white uppercase tracking-wider">Inquiry Dispatched</h3>
                                            ...
                                            <button 
                                                ...
                                                className="px-4 py-2 bg-brand-slateLight text-xs font-bold uppercase tracking-wider border border-white/10 rounded-lg hover:border-brand-teal transition-all text-slate-300"
                                            >
                                                Submit Another
                                            </button>
                                        </div>
                                        ...
                                        <form onSubmit={handleFormSubmit} className="space-y-4">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input 
                                                        ...
                                                        className="w-full bg-brand-slate border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-brand-teal placeholder:text-slate-600 transition-colors"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div className="space-y-1.5">
                                                    <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Organization</label>
                                                    <input 
                                                        type="text" 
                                                        value={formData.org}
                                                ...
                                                <div className="space-y-1.5">
                                                    <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Consultation Focus</label>
                                                    <select 
                                                        value={formData.interest}
                                                        onChange={(e) => setFormData(prev => ({ ...prev, interest: e.target.value }))}
                                                        className="w-full bg-brand-slate border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-brand-teal transition-colors"
                                                    >
                                            ...
                                            <div className="space-y-1.5">
                                                <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Message Summary *</label>
                                                <textarea 
                                                    rows="4" 
                                                    required
                                                    ...
                                                    className="w-full bg-brand-slate border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-brand-teal placeholder:text-slate-600 transition-colors resize-none"
                                                ></textarea>
                                            </div>

                                            <button 
                                                type="submit"
                                                className="w-full py-3 bg-brand-teal hover:bg-brand-tealLight text-white font-bold rounded-lg uppercase tracking-wider transition-colors text-xs flex items-center justify-center gap-2 shadow-lg"
                                            >
                    ...
                    {/* Footer Section */}
                    <footer className="border-t border-slate-800 mt-20 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
                        <div className="space-y-1">
                            <p className="text-sm font-semibold text-white uppercase tracking-wider">Dr. Diana B. Allen</p>
                            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em]">Security &bull; Compliance &bull; Leadership</p>
                        </div>
                        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6 text-[11px] font-mono text-slate-500">
